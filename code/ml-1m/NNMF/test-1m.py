...
train_set_supp, train_set_que, test_set_supp, test_set_que, user_supp_list, user_his_dic = generate_data(datadir=datadir, 
							dataset=DATASET,
							split_way=SPLIT_WAY,
							threshold=THRESHOLD,
							training_ratio=TRAINING_RATIO,support_ratio=SUPP_RATIO)
...
load_model(model, path='/Users/vedantpalit/Desktop/IDCF-master/code/ml-1m/IDCF-NN/pretrain-1m/')
